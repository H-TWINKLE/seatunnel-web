...
public class UdpDataSourceFactory implements DataSourceFactory {

    public static final String PLUGIN_NAME = "Udp";
    public static final String UDP_PLUGIN_ICON = "Udp";
    public static final String UDP_PLUGIN_VERSION = "1.0.0";
    ...
    public Set<DataSourcePluginInfo> supportedDataSources() {
        return Sets.newHashSet(
                DataSourcePluginInfo.builder()
                        .name(PLUGIN_NAME)
                        .icon(UDP_PLUGIN_ICON)
                        .version(UDP_PLUGIN_VERSION)
    ...
    public DataSourceChannel createChannel() {
        return new UdpDataSourceChannel();
    }
}
