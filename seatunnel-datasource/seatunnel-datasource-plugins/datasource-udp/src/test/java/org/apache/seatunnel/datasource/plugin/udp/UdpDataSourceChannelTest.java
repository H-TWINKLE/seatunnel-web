...
@Slf4j
@Disabled
public class UdpDataSourceChannelTest {

    private static final UdpDataSourceChannel KAFKA_DATA_SOURCE_CHANNEL =
            new UdpDataSourceChannel();
    ...
    private static final Map<String, String> REQUEST_PARAMS =
            new ImmutableMap.Builder<String, String>()
                    .put(UdpOptionRule.HOST.key(), BOOTSTRAP_SERVER)
                    .build();
